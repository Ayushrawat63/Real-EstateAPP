      ...
      <div className="features">
        <div className="wrapper">
          ...
          <div className="listVertical">
            <div className="feature">
              ...
              <div className="featureText">
                <span>Utilities</span>
                <p>{post.postDetail.utilities === "owner" ? "owner is responsible" : "Renter is responsible"}</p>
              </div>
            </div>
            <div className="feature">
              <img src="/pet.png" alt="" />
              <div className="featureText">
                ...
                <p>{post.postDetail.pet==="allowed"? "Pet Allowed":"Pet not Allowed"}</p>
              </div>
            </div>
            <div className="feature">
              <img src="/fee.png" alt="" />
          ...
          <div className="buttons">
            ...
            <button onClick={saveHandler} style={{backgroundColor: save ? "#fece51" : "white",}}>
